...
project = 'Програмирање у Скречу 3.0, практикум за пети разред'
#pylint: disable=redefined-builtin
copyright = '2020 nevenka'
...
html_context = {'course_id': 'scratch3-praktikum',
...
html_theme_options = {
    ...
    'navbar_title': "Програмирање у Скречу 3.0, практикум за пети разред",
...
html_title = 'Програмирање у Скречу 3.0, практикум за пети разред'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Програмирање у Скречу 3.0, практикум за пети разред'
...
htmlhelp_basename = 'scratch3-praktikum-doc'
